...
SELECT * FROM (VALUES
  ('Pro Monthly',
   ...
   ARRAY['Unlimited bookings','Automated appointment reminders','Customer reviews',
         'Featured marketplace listing requests','Vendor dashboard',
         'Trust & no-show protection','Analytics','Priority support'],
   49.00::numeric, 'BBD', 'monthly', true, 1,
   'com.shorisolutions.shoribook.pro.monthly',
   'com.shorisolutions.shoribook.pro.monthly'),
  ('Pro Annual',
   'Two months free vs. paying monthly.',
   ARRAY['Everything in Pro Monthly','Best value - save ~17%'],
   490.00::numeric, 'BBD', 'annual', false, 2,
   'com.shorisolutions.shoribook.pro.annual',
   'com.shorisolutions.shoribook.pro.annual')
