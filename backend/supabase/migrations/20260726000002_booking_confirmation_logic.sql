...
-- 7. Surface confirmation state to guests too (My Bookings). Same fixed JSON
--    shape as before, plus the four confirmation fields so a guest can see a
--    pending-confirmation booking and confirm it. (Copied from
--    20260717000001; only the four added keys differ.)
